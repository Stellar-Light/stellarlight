...
// Sequential intensity ramp, violet, DIM -> BRIGHT: on a dark surface
// "more" must be the brighter step (the old gold ramp ran the other way, so
// the fullest heatmap cells were the least visible). Stepped from the
// Tailwind violet stops and checked against the dark chart surface: the dim
// end is deliberately quiet (it means "less"), every step monotonic in
// lightness, hover + tooltips carry the exact values.
const RAMP = ["#5b21b6", "#7c3aed", "#8b5cf6", "#a78bfa", "#c4b5fd"];
const ACCENT = "#a78bfa";
