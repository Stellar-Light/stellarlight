...
- Top 25 distinct queries replayed against the live API **today**: **21/25 ok** (84%)
...
| tyler van der hoeven | `/api/builders` | 11 | ✗ EMPTY |
...
| justin rice | `/api/builders` | 9 | ✗ EMPTY |
...
### Open misses (4) — our fix queue

- `/api/research?q=test` — weak (asked 42×, last 2026-07-20)
- `/api/builders?q=strupey` — empty (asked 17×, last 2026-07-14)
- `/api/builders?q=tyler%20van%20der%20hoeven` — empty (asked 11×, last 2026-07-19)
- `/api/builders?q=justin%20rice` — empty (asked 9×, last 2026-07-18)
