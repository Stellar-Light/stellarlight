...
export interface Project {
	...
	publicGoods?: {
		 ...
		 */
		awardRounds?: string[] | null;
		/**
		 * Proposal PR / round-CSV evidence for the award claim
		 */
...
export interface Repo {
	 ...
	 */
	codeScanState?:
		| ("pending" | "scanned" | "error" | "incomplete" | "gone")
		| null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "stablecoins".
 */
export interface Stablecoin {
	id: string;
	/**
	 * CODE-<issuer[0:8]> — the natural key
	 */
	assetId: string;
	code: string;
	/**
	...
	website?: string | null;
	/**
	 * Fiat the asset claims parity with (USD, EUR, …)
	 */
	peg?: string | null;
	country?: string | null;
	/**
	 ...
	 */
	logoSource?:
		| ("toml" | "toml-org" | "fallback" | "country-flag" | "none")
		| null;
	/**
	...
	/**
	 * When these figures were taken. Always cite it.
	 */
	measuredAt: string;
	/**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "stablecoin-snapshots".
 */
...
export interface PayloadLockedDocument {
	...
	document?:
		...
		| ({
				relationTo: "stablecoins";
				value: string | Stablecoin;
		  } | null)
		| ({
				relationTo: "stablecoin-snapshots";
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "stablecoins_select".
 */
export interface StablecoinsSelect<T extends boolean = true> {
	assetId?: T;
	code?: T;
	issuer?: T;
	name?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "stablecoin-snapshots_select".
 */
export interface StablecoinSnapshotsSelect<T extends boolean = true> {
	key?: T;
	assetId?: T;
	code?: T;
	issuer?: T;
