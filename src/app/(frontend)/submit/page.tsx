...
export default function SubmitPage() {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		formData.github.repos.forEach((repo, index) => {
			if (!repo.owner.trim()) {
				errors[`github.repos.${index}.owner`] = "Repository owner is required";
			}
			if (!repo.name.trim()) {
							...
							<div className="text-center space-y-6">
								...
								<div>
									...
									<p className="text-lg text-muted-foreground">
										Your project submission has been received and is pending
										review.
									</p>
								</div>
							...
							<form onSubmit={handleSubmit} className="space-y-6">
								...
								<div className="space-y-4 pt-4 border-t border-border">
									...
									<div className="space-y-2">
										...
										/>
										<p className="text-xs text-muted-foreground">
											Organization login (e.g., "stellar" for
											github.com/stellar)
										</p>
									</div>
									...
									<div className="space-y-3">
										...
										<div className="flex gap-2">
											...
											<Button
												...
												className="h-10 px-4"
												disabled={!newRepo.owner.trim() || !newRepo.name.trim()}
											>
								...
								<Alert className="border-2 border-blue-500/20 bg-blue-500/10">
									...
									<AlertDescription className="text-sm">
										<strong>Important:</strong> Projects submitted from this
										form will be set to Draft status and require admin approval
										before appearing in the public directory. You'll be notified
										once your project has been reviewed.
									</AlertDescription>
								</Alert>
