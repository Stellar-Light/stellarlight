...
const SESSIONS = [
	{
		...
		response: {
			...
			rows: [
				{ label: "Kulipa", value: "$150,000 SCF", meta: "Payments · stellarlight.xyz/project/kulipa" },
				{ label: "StellarPay", value: "$148,400 SCF", meta: "Payments · stellarlight.xyz/project/stellarpay" },
				{ label: "Wirex Pay", value: "$150,000 SCF", meta: "User-Facing App · stellarlight.xyz/project/wirex-pay" },
				{ label: "PayZoll", value: "$100,000 SCF", meta: "Payments · stellarlight.xyz/project/payzoll" },
			],
			footer:
	...
	},
	{
		...
		response: {
			summary: "Reframe accepted? Selective-disclosure stablecoin, Stellar-native.",
			rows: [
				{ label: "Crowdedness", value: "2/10", meta: "1 abandoned adjacent project · 0 SCF-funded · 0 hackathon winners" },
				{ label: "Gap classification", value: "Partial → Full (with selective-disclosure framing)", meta: "The privacy-only lane is a regulatory dead-end; the selective-disclosure lane is wide open." },
				{ label: "Direct competitors", value: "None active", meta: "XLM Shielded (abandoned 2024). Adjacent: 2 ZK-curious projects in directory." },
				{ label: "SDK recommendation", value: "zk-proofs + soroban", meta: "Install both from skills.stellar.org" },
				{ label: "Funding signal", value: "Open", meta: "0 SCF-funded ZK/privacy projects on Stellar — significant whitespace." },
				{ label: "Next step", value: "Build for SCF Round Q2 2026", meta: "No open RFP matches; you could submit one via stellarlight.xyz/ideas." },
			],
			footer:
	...
	},
	{
		...
		response: {
			...
			rows: [
				{ label: "1. Project setup", value: "soroban-cli + Rust toolchain", meta: "Pinned versions in the skill" },
				{ label: "2. Storage types", value: "Persistent / Temporary / Instance", meta: "TTL semantics + archival behavior" },
				{ label: "3. Authorization", value: "require_auth() patterns", meta: "Common pitfalls covered in the skill" },
				{ label: "4. Testing", value: "Unit / integration / fuzz / property", meta: "Mutation + fork + differential tests too" },
				{ label: "5. Vulnerabilities", value: "Storage hygiene, TTL, reentrancy-adjacent bugs", meta: "Full checklist in the skill" },
			],
			footer:
	...
	},
	{
		...
		response: {
			...
			rows: [
				{ label: "Stellar Hacks: Agents", value: "$10,000 pool", meta: "DoraHacks · track-level data not curated yet" },
				{ label: "Stellar Hacks: KALE × Reflector", value: "$12,000 pool", meta: "DoraHacks · track-level data not curated yet" },
				{ label: "Stellar Hacks: ZK Gaming", value: "$10,000 pool", meta: "DoraHacks · track-level data not curated yet" },
				{ label: "Scaffold Stellar Hackathon", value: "$10,000 pool", meta: "DoraHacks · track-level data not curated yet" },
			],
			footer:
	...
	},
	{
		...
		response: {
			summary: "10 SCF-funded payments projects on Stellar. Combined: $859,692.",
			rows: [
				{ label: "Kulipa", value: "$150,000", meta: "User-Facing App · payments rails for African corridors" },
				{ label: "Rozo", value: "$150,000", meta: "Payments · QR-based payment dApp" },
				{ label: "StellarPay", value: "$148,400", meta: "Payments · multi-country payments processor" },
				{ label: "PayZoll", value: "$100,000", meta: "Payments · payroll-to-stablecoin pipeline" },
				{ label: "TheXBank", value: "$89,500", meta: "User-Facing App · banking interface" },
				{ label: "SFx", value: "$55,000", meta: "Protocol/Contract · FX corridor" },
			],
			footer:
	...
	},
	{
		...
		response: {
			...
			rows: [
				{ label: "Prices API & Indexing Service", value: "Q1 2026 · Infrastructure", meta: "stellarlight.xyz/ideas/prices-api" },
				{ label: "Author", value: "Jake", meta: "RFP description matches your idea closely" },
				{ label: "Tech requirements", value: "Asset coverage (Classic + SEP-41), VWAP, real-time + historical endpoints, low-latency", meta: "Full spec on the RFP page" },
				{ label: "Funding", value: "SCF-funded for the winning team", meta: "Apply via the Stellar Community Fund" },
			],
			footer:
