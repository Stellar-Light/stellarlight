...
export function selectDepthPaths(
	...
	const OTHER_MANIFEST =
		/(^|\/)(package\.json|stellar\.toml|package\.swift|podfile|build\.gradle(\.kts)?|pubspec\.yaml|composer\.json|go\.mod|requirements\.txt|pyproject\.toml|setup\.py|setup\.cfg)$/i;
	const others = tree
