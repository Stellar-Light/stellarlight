		...
		"/api/paid-endpoints": {
			get: {
				...
				"x-routing": {
					...
					useWhen:
						"An agent or builder asks what paid APIs / x402 or MPP endpoints exist on Stellar, whether an endpoint is payable from a Stellar wallet, or what an agent can buy with USDC on Stellar.",
				},
				parameters: [
					{
						name: "stellarOnly",
						...
						description:
							"Only endpoints whose read challenge listed a Stellar network. The usual filter.",
					},
					{
						name: "live",
						in: "query",
					...
					},
					{
						...
						schema: {
							type: "string",
							enum: ["x402", "mpp", "x402+mpp", "unknown"],
						},
					},
				...
				responses: {
					"200": {
						description:
							"Probed paid endpoints; meta.counts carries returned/total/acceptsStellar/answering402.",
						content: { "application/json": { schema: { type: "object" } } },
					},
					"400": { description: "Unknown query param or invalid protocol." },
					"503": {
						description:
							"Index unavailable — explicitly NOT a report that no paid endpoints exist on Stellar.",
					},
				},
			},
		},
